...
public class Alchimistes3 extends Croyant {
	...
	public Alchimistes3(){
		...
		Image image = null;
	//	image = getImages.getPng("Alchimiste2");
	//	this.setImage(image);
	}
	    
	  //Emp¨ºche une Divinit¨¦ poss¨¦dant le Dogme Humain ou Symboles 
	...
	public void utiliserCapacite(Joueur j,Partie partie){
		...
		System.out.println("Alchimiste3:");
		...
		if(j.getNumeroJoueur() != 1){
			...
			System.out.println("Emp¨ºche une Divinit¨¦ poss¨¦dant le Dogme Humain ou Symboles " +
					" de sacrifier un de ses Guides Spirituels durant ce tour de jeu.");
			n = sc.nextInt();
