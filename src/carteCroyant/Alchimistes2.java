...
public class Alchimistes2 extends Croyant {
	...
	public Alchimistes2(){
		...
		Image image = null;
	//	image = getImages.getPng("Alchimiste1");
		//this.setImage(image);
	}
	
	  //Empêche une Divinité possédant le Dogme Humain ou Mystique 
	...
	public void utiliserCapacite(Joueur j,Partie partie){
		...
		System.out.println("Alchimiste2:");
		...
		if(j.getNumeroJoueur() != 1){
			...
			System.out.println("Empêche une Divinité possédant le Dogme Humain ou Mystique de" +
		...
		if(targetJoueur.getDivinite().getDiviniteDogme().contains("Humain")|| targetJoueur.getDivinite().getDiviniteDogme().contains("Mystique")){
