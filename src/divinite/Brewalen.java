...
public class Brewalen extends Divinite {
	...
	//	this.setImageDivinite(image);
	  ...
	  //Peut emp¨ºcher l'utilisation d'une carte Apocalypse. La carte est d¨¦fauss¨¦e;
	public void capaciteDivinite(Partie partie,Joueur j){
		if(capacite == true){
			System.out.println("Brewalen:");
			System.out.println("Peut emp¨ºcher l'utilisation d'une carte Apocalypse. La carte est d¨¦fauss¨¦e;");
