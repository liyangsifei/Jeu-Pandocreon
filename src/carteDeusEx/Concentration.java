...
public class Concentration extends DeusEx {
	...
	public  Concentration(){
		...
		this.origine = "Néant";
		Image image = null;
		//image = getImages.getPng("Concentration");
		//this.setImage(image);
	}
	
	//Vous récupérez un des Guides Spirituels posés devant une autre Divinité et 
	//le placez devant vous avec les Croyants qui y sont attachés.
	 public void utiliserCapacite(Joueur j,Partie partie){
		 if(this.utiliser==true){
		 System.out.println("Utiliser Carte DeusEx: Concentration");
