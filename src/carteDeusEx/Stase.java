...
public class Stase extends DeusEx{
    ...
    public Stase(){
   	 ...
   	 this.origine = "Jour";
   	Image image = null;
//	image = getImages.getPng("Stase");
	//this.setImage(image);
    }
    
    //Protège un Guide Spirituel et ses Croyants jusqu'à ce que 
    //cette carte soit annulée ou jusqu'à la prochaine tentative d'Apocalypse.
    public void utiliserCapacite(Joueur j,Partie partie){
    	if(this.utiliser==true){
    	 System.out.println("Utiliser Carte DeusEx: Stase");
